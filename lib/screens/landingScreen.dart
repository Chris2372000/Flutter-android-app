...
import 'package:larafoods/screens/loginScreen.dart';
            ...
            Align(
              ...
              child: Container(
                ...
                child: Column(children: [
                  Flexible(
                    child: Text(
                      "Discover the best foods from our restaurants and delivery to your door ",
...
class CustomClipperAppBar extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    Offset controlPoint2 = Offset(size.width * 0.24, size.height * 0.70);
